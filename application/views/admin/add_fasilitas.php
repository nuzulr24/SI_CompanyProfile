	...
	<div id="content">
		<section class="style-default-bright">
			...
			<div class="section-body">
				...
				<div class="card">
					<div class="card-body">
						<form class="form-horizontal" role="form" action="<?= base_url('administrator/fasilitas/tambah'); ?>" method="post" enctype="multipart/form-data">
							...
							<div class="form-group" style="margin-bottom: 20px;">
								<label for="nama_barang" class="col-sm-2 control-label">Nama Judul</label>
								<div class="col-sm-10">
									<input type="text" class="form-control" id="nama_barang" name="nama_barang" placeholder="Nama Judul" value="<?= set_value('nama_barang') ?>">
