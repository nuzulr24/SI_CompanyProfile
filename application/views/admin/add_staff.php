	...
	<div id="content">
		<section class="style-default-bright">
			...
			<div class="section-body">
				...
				<div class="card">
					<div class="card-body">
						<form class="form-horizontal" role="form" action="<?= base_url('administrator/staff/tambah'); ?>" method="post" enctype="multipart/form-data">
							...
							<div class="form-group" style="margin-bottom: 20px;">
								...
								<div class="col-sm-10">
									<input type="text" class="form-control" id="nama_barang" name="nama_barang" placeholder="Nama Lengkap" value="<?= set_value('nama_barang') ?>">
